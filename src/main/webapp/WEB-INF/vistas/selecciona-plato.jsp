...
function ventanaSecundaria (URL){ 
   window.open(URL,"ventana1","width=520,height=500,scrollbars=NO") 
} 
</script>
...
<section class="ftco-section ftco-no-pt ftco-no-pb" style="    margin-bottom: 1em;">
  ...
  <div class="row d-flex">
   ...
   <div class="col-md-6 ftco-animate makereservation p-4 p-md-5">
     <div class="heading-section ftco-animate mb-5">
      ...
      class="btn btn-primary"> Lista de Ingredientes</a></p></div>
    </div>
  </div>
</div>
</div>
 ...
 <br>
				<p><a href="seleccionar-ingrediente" class="btn btn-success">Volver a seleccionar ingredientes</a></p>
				</div>
			</div>
		</div>
			</section>
